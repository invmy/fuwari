...
const cdn = `https://cdn.jsdelivr.net/gh/invmy/fuwari@blog`

// 读取图片文件夹
const imgdir = `gallery`
const outdir = `dist`
...
<body>
    <!-- 返回主页按钮 -->
    <a href="gallery.html" class="back-button">Go Back</a>
    <br>
    <h1>${folderName}</h1>
...
function generateIndexHTML() {
  ...
  console.log('gallery.html 生成完成:', outputFile)
}
